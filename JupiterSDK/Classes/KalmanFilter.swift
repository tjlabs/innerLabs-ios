...
//    }
//    
//    func timeUpdate2(timeUpdatePosition: KalmanOutput, length: Double, diffHeading: Double, mobileTime: Int) -> FineLocationTrackingResult {
//        updateHeading = timeUpdatePosition.heading + diffHeading
//        
//        timeUpdateOutput.x = Int(timeUpdatePosition.x + (length*cos(updateHeading*D2R)))
//        timeUpdateOutput.y = Int(timeUpdatePosition.y + (length*sin(updateHeading*D2R)))
...
////        print("Kalman Check (Meas Update) -> x :\(measurementPosition.x) , y :\(measurementPosition.y) , heading :\(measurementPosition.heading))")
//        
